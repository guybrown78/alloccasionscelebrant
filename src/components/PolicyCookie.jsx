    ...
    <Container>
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none space-y-4">
					...
					<p>If you have any questions or concerns about our Cookie Policy, please contact us at <a className="underline cursor-pointer" href="mailto:caroline@alloccasionscelebrant.com">caroline@alloccasionscelebrant.com</a>.</p>
				</div>
			</div>
		</Container>
  )
