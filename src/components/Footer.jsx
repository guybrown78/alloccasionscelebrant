          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-6">
						...
						{/* <Link	
								...
								<Link
									href="https://www.facebook.com/profile.php?id=61550956029548"
									className="group"
								...
								<Link
									href="https://www.linkedin.com/in/caroline-brown-aaa117293/"
									className="group"
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <h3 className="text-sm font-semibold leading-6 text-gray-900">Contact</h3>
                    ...
                    <li>
                      <a href="tel:+447843498738" className="text-sm leading-4 text-slate-600 hover:text-slate-900 hover:underline">
                        07843 498738
                      </a>
										</li>
										<li>
